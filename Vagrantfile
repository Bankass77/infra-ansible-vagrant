...
servers=[
  ...
  },
  {
    ...
    :ip => "#{BRIDGE_NET}" + "155",
    :ram => "#{RAM}",
	:install_ansible => "./infra-ansible-vagrant/artefacts/scripts/install_ansible.sh", 
	:config_ansible => "./infra-ansible-vagrant/artefacts/scripts/config_ansible.sh",
	:source =>  "./artefacts/.",
	:destination => "~/opt/vagrant/"
  }
]
