...
dos2unix ~/infra-ansible-vagrant/artefacts/scripts/ssh_pass.sh
chmod +x ~/infra-ansible-vagrant/artefacts/scripts/ssh_pass.sh
#chown vagrant:vagrant ssh_pass.sh 

# password less authentication using expect scripting language
~/infra-ansible-vagrant/artefacts/scripts/ssh_pass.sh $USER $PASSWORD "ansible.sample.com" 
~/infra-ansible-vagrant/artefacts/scripts/ssh_pass.sh $USER $PASSWORD "nfsclient.sample.com" 
~/infra-ansible-vagrant/artefacts/scripts/ssh_pass.sh $USER $PASSWORD "nfsserver.sample.com" 
~/infra-ansible-vagrant/artefacts/scripts/ssh_pass.sh $USER $PASSWORD "docker.sample.com" 
~/infra-ansible-vagrant/artefacts/scripts/ssh_pass.sh $USER $PASSWORD "jenkins.sample.com"
~/infra-ansible-vagrant/artefacts/scripts/ssh_pass.sh $USER $PASSWORD "gitlab.sample.com"

ansible-playbook ~/infra-ansible-vagrant/artefacts/playbooks/nfs_server.yaml
ansible-playbook ~/infra-ansible-vagrant/artefacts/playbooks/nfs_clients.yaml
ansible-playbook ~/artefacts/playbooks/install_java.yaml
ansible-playbook ~/infra-ansible-vagrant/artefacts/playbooks/install_jenkins.yaml
ansible-playbook ~/infra-ansible-vagrant/artefacts/playbooks/install_docker.yaml
ansible-playbook ~/infra-ansible-vagrant/artefacts/playbooks/install_gitlab.yaml
